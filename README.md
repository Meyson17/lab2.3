...
<p align="right"><b>Выполнил: </b> студент 331 группы Рыжков В.Э. </p>
...
const token = '6765874834:AAG43Zcly4YXnuydR9CUSZn8R_gQbVaKh_A'
...
bot.on('message', msg => {
        ...
        if (text === '/start') {
             bot.sendSticker(chatId, `https://chpic.su/_data/stickers/m/MenheraKunBIC/MenheraKunBIC_001.webp`)
             bot.sendMessage(chatId, `HELLOW! `);
